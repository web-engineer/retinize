...
"$1-x"+d+".$2"));c+='src="'+a+'" ';if(typeof g=="object")for(var h in g)c+=h+'="'+g[h]+'" ';c+='width="'+f+'" ';c+='height="'+b+'" ';c+=" />";document.write(c)},support:function(a,f){if(typeof Retinize.isSupported!="boolean"){console.info("setting support");var b=-1;navigator.appName=="Microsoft Internet Explorer"?(/MSIE ([0-9]{1,}[.0-9]{0,})/.exec(navigator.userAgent)!=null&&(b=parseFloat(RegExp.$1)),Retinize.isSupported=b>8):Retinize.isSupported=true}if(Retinize.isSupported===true)b=document.createElement("link"),
